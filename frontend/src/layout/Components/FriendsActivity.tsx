...
const FriendsActivity = () => {
    ...
    // Mock userActivities for now - replace with actual implementation
    const userActivities = new Map<string, string>([
        // Example: ['clerkId', 'Playing Song Title by Artist']
    ]);
                        ...
                        <div key={user._id} className="cursor-pointer hover:bg-zinc-800/50 p-3 rounded-md transition-colors group">
                            <div className="flex items-start gap-3">
                                <div className="relative">
                                    ...
                                    <div className="absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-zinc-800 bg-zinc-500" aria-hidden="true"></div>
                                </div>
