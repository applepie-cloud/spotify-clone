...
const AlbumPage = () => {
	...
	if(!currentAlbum) return <div className="flex items-center justify-center h-full">iski MKC</div>
					...
					<div className='relative z-10'>
						<div className='flex p-6 gap-6 pb-8'>
							...
							<div className='flex flex-col justify-end'>
								...
								<h1 className='text-7xl font-bold my-4'>{currentAlbum?.albumName}</h1>
								<div className='flex items-center gap-2 text-sm text-zinc-100'>
									<span className='font-medium text-white'>{currentAlbum?.artists?.[0] || 'Unknown Artist'}</span>
                      ...
                      `}
											>
												...
												<div className='flex items-center gap-3'>
													<img src={song.songImgURL} alt={song.title} className='size-10' />

													<div>
														<div className={`font-medium text-white`}>{song.title}</div>
														<div>{song.artists?.[0] || 'Unknown Artist'}</div>
													</div>
												</div>
